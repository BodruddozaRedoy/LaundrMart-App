...
export default function PlaceOrderScreen() {
    const [selectedOption, setSelectedOption] = useState<"now" | "later" | null>(
        "now"
    );
  ...
  return (
      <View className="flex-1 bg-white p-5">
          ...
          <Text className="text-[#64748B] mb-6">Schedule your pickup time</Text>
          ...
          >
              ...
              <View>
                  <Text
                      className={`text-base font-semibold ${selectedOption === "now" ? "text-primary" : "text-[#1E293B]"
                          }`}
                  >
                      Pickup Now
                  </Text>
          ...
          >
              ...
              <View>
                  <Text
                      className={`text-base font-semibold ${selectedOption === "later" ? "text-primary" : "text-[#1E293B]"
                          }`}
                  >
                      Schedule for Later
                  </Text>
